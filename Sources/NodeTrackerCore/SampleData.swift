...
public extension SnapshotService {
    static func sampleSnapshot(
        ...
        let sampleNodeGroups = [
            NodeProcessGroup(toolLabel: "node", count: 14, totalMemoryBytes: 481 * 1024 * 1024, pids: Array(22000..<22014)),
            NodeProcessGroup(toolLabel: "npm", count: 9, totalMemoryBytes: 172 * 1024 * 1024, pids: Array(23000..<23009)),
            NodeProcessGroup(toolLabel: "nest", count: 3, totalMemoryBytes: 94 * 1024 * 1024, pids: Array(24000..<24003)),
            NodeProcessGroup(toolLabel: "expo start", count: 3, totalMemoryBytes: 88 * 1024 * 1024, pids: Array(25000..<25003)),
        ]
